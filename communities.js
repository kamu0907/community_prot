...
async function loadCommunities() {
  ...
  try {
    ...
    communities.forEach((community) => {
      listElement.appendChild(renderCommunity(community));
    });
    ...
    console.error(error);
    messageElement.textContent =
      "コミュニティ一覧を読み込めませんでした。ページを再読み込みしてください。";
  }
}
